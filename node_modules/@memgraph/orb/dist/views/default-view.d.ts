...
import { IRendererSettingsInit, IRendererSettings } from '../renderer/shared';
...
export declare type IDefaultViewSettingsInit<N extends INodeBase, E extends IEdgeBase> = Omit<Partial<IDefaultViewSettings<N, E>>, 'render'> & {
...
export declare class DefaultView<N extends INodeBase, E extends IEdgeBase> implements IOrbView<IDefaultViewSettings<N, E>> {
    ...
    mouseRightClicked: (event: PointerEvent) => void;
    private _initCanvas;
