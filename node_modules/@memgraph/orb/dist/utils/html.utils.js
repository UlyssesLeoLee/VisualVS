export const setupContainer = (container, areCollapsedDimensionsAllowed = false) => {
    ...
    if (!areCollapsedDimensionsAllowed && isCollapsedDimension(style.width)) {
        ...
        if (isCollapsedDimension(getComputedStyle(container).width)) {
            ...
            console.warn("[Orb] The graph container element and its parent don't have defined width properties.", 'If you are using percentage values,', 'please make sure that the parent element of the graph container has a defined position and width.', "Setting the width of the graph container to an arbirtrary value of '400px'...");
        }
        else {
...
export const isCollapsedDimension = (dimension) => {
